...
<div style="padding-top: 20px; padding-left: 8px;" class="panel">
        <div class="panel-heading"><h5>MW LINKS INSTALLATIONS</h5> </div>
   <div class="panel-body">
       <img class="image img-responsive" src="{{ asset('wp-content/perntels/tele/link.png')}}"/><br><br>
...
<div class="summary entry-summary">
    <br><br>
    <p>Perntels has quality microwave radio technical engineers and our business strategy has ensured that we retain valuable, long term, committed field engineering resource to support our customers needs.  </p>
    <div class="panel-heading"><h5 itemprop="name">Our services in MW Links includes:</h5></div>
