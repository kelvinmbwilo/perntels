                ...
                <div class="summary entry-summary">
                    ...
                    <div class="description" itemprop="description">
                        <ul>
                          ...
                          <li>Supply and installation all kinds of antenna poles	</li>
                          <li>Installation of antennas and feeder/fiber routing </li>
                          <li>Integration and E1 commissioning</li>
                          <li>Power checking and BTS integration with BSC</li>
                          </ul>
                    </div>
                </div>
            </div>
